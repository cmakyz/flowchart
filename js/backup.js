...
(function(){
    ...
    // import {IfParser} from '../../scripts/parser';
     ...
     class Formula_IfStatement {
        ...
        get index() {
            return this.containingArray.length > 1 ? Object.keys(Object.filter(Formula_FlowchartApp.similarIfMapper, ifObjectArray => ifObjectArray.length > 1)).indexOf(this.json) + 1 : null;
        }
    ...
    // /.
     ...
     class Formula_FlowchartApp {
        ...
        static updateNumbers() {
            // //console.log(Object.filter(FlowchartApp.similarIfMapper, value => value.length > 1));
